window.onload=function() {
	...
	//左导航栏：
	  ...
	  document.getElementById("chooseBtn").onclick=function(){
	  	if(document.getElementById("mytext").value!='请输入培训课程名'){
		  var histogramBox=document.getElementsByClassName("histogram-box");
		  for(var i=0;i<histogramBox.length;i++){
		  	histogramBox[i].getElementsByTagName("a")[0].style.height=Math.random()*100+"%";
		  }	  	  		
	  	}
	  	else{
